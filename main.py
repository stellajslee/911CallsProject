...
if st.sidebar.button('Press to see total time spent for each location'):
    st.sidebar.text("Total time from start (Hospital 1): " + str(totalTimeH1) + " mins")
    st.sidebar.text("Total time from start (Hospital 2): " + str(totalTimeH2) + " mins")
    st.sidebar.text("Total time from start (Fire Station 1): " + str(totalTimeF1) + " mins")
    st.sidebar.text("Total time from start (Fire Station 2): " + str(totalTimeF2) + " mins")
